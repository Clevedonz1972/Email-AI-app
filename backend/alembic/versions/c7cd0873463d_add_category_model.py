...
def upgrade() -> None:
    ...
    op.add_column(
        "email_analytics", sa.Column("stress_score", sa.Float(), nullable=True)
    )
    op.add_column(
        "email_analytics", sa.Column("priority_score", sa.Float(), nullable=True)
    )
    op.add_column(
        "email_analytics", sa.Column("sentiment_score", sa.Float(), nullable=True)
    )
    op.add_column(
        "email_analytics", sa.Column("analysis_data", sa.JSON(), nullable=True)
    )

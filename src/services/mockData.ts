...
export const mockEmails: EmailMessage[] = [
  {
    ...
    action_items: [
      {
        id: 'action-1-1',
        description: 'Adjust project timeline',
        completed: false
      },
      {
        id: 'action-1-2',
        description: 'Update team on new deadline',
        completed: false
      }
    ],
  ...
  },
  {
    ...
    action_items: [
      {
        id: 'action-3-1',
        description: 'Attend team lunch at 12:30 PM',
        completed: false
      },
      {
        id: 'action-3-2',
        description: 'Mark in calendar',
        completed: false
      }
    ],
